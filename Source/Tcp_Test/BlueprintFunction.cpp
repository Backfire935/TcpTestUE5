...
void UBlueprintFunction::send_FString_len(FString value, int32 len)
{
	...
	int size = value.GetCharArray().Num();//��ȡ����
	if(size > len) size = len;//������ȴ���len������Ϊlen
	app ::__TcpClient->sss(cc, size);//��������
	if(size <= len) return;//�����ȣ�ֱ�ӷ���

	int a = size -len;//�����ֵ
	uint8* cc2 = (uint8*)FMemory::Malloc(a);//�����ڴ�
	app::__TcpClient->sss(cc2, a);//�������� ����벻����
	
	FMemory::Free(cc2);//�ͷ��ڴ�
}
